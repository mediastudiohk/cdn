...
const PATH = 'https://cdn.jsdelivr.net/gh/mediastudiohk/cdn/manugames/word-a-mole/';
...
function DrawSwitch(x,y,w,h,m,t){
  var r = Mouse.Square(x-w/2,y,w,h);
  ctx.globalAlpha = t?1:r?0.6:0.5;
  ctx.drawImage(m,x-w/2,y,w,h);
  ctx.globalAlpha = 1;
  return r;
}
